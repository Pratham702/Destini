...
class StoryBrain {
  ...
  void nextStory(int choiceNumber){
    ...
    if(choiceNumber==1&&_storyNumber==2) _storyNumber=5;
    if(choiceNumber==2&&_storyNumber==2) _storyNumber=4;
    if(choiceNumber==1&&_storyNumber==1) _storyNumber=2;
    if(choiceNumber==2&&_storyNumber==1) _storyNumber=3;
